...
function RoleBadge({ role }: { role: Role }) {
  const colors: Record<Role, { bg: string; text: string; icon: React.ReactNode }> = {
    [Role.NONE]: { bg: "bg-gray-100", text: "text-gray-700", icon: <UserIcon className="w-4 h-4" /> },
      ...
      case Role.PRODUCER:
        return (
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <KPICard title="Transferencias" value="0" subtitle="Ver historial" icon={<svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" /></svg>} />
          </div>
        );
      case Role.FACTORY:
        return (
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <KPICard title="Estado" value="Activo" subtitle="Aprobado" icon={<CheckIcon className="w-5 h-5" />} />
            <KPICard title="Transformaciones" value="0" subtitle="Realizadas" icon={<svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0013.803-3.7M4.031 9.865a8.25 8.25 0 0113.803-3.7l3.181 3.182m0-4.991v4.99" /></svg>} />
          </div>
        );
      case Role.RETAILER:
        return (
      ...
      case Role.CONSUMER:
        return (
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <KPICard title="Estado" value="Activo" subtitle="Aprobado" icon={<CheckIcon className="w-5 h-5" />} />
            <KPICard title="Consumo" value="0" subtitle="Tokens redimidos" icon={<svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M15.362 5.214A8.252 8.252 0 0112 21 8.25 8.25 0 016.038 7.048 8.287 8.287 0 009 9.6a8.983 8.983 0 013.361-6.867 8.21 8.21 0 003 2.48z" /></svg>} />
          </div>
        );
      default:
        return null;
